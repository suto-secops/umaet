...
public:
    ...
    Q_INVOKABLE bool addTransaction(const QString &type, double amount, const QString &category, const QString &date, const QString &note);
    Q_INVOKABLE bool updateTransaction(int id, const QString &type, double amount, const QString &category, const QString &date, const QString &note);
